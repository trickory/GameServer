    ...
    class HandleChatBoxMessage : IPacketHandler
    {
        ...
        public bool HandlePacket(Peer peer, byte[] data)
        {
            ...
            if (message.msg.StartsWith(CommandStarterCharacter))
            {
                ...
                {
                    _chatCommandManager.SendDebugMsgFormatted(ChatCommandManager.DebugMsgType.Error, "<font color =\"#E175FF\"><b>" + ChatCommandManager.CommandStarterCharacter + split[0] + "</b><font color =\"#AFBF00\"> is not a valid command.");
                    _chatCommandManager.SendDebugMsgFormatted(ChatCommandManager.DebugMsgType.Info, "Type <font color =\"#E175FF\"><b>" + ChatCommandManager.CommandStarterCharacter + "help</b><font color =\"#AFBF00\"> for a list of available commands");
                    return true;
                }
            }
            #endregion
