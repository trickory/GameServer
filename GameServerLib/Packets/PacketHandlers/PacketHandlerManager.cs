...
namespace LeagueSandbox.GameServer.Packets.PacketHandlers
{
    public class PacketHandlerManager
    {
        ...
        public bool sendPacket(Peer peer, Packets.Packet packet, Channel channelNo, PacketFlags flag = PacketFlags.Reliable)
        {
        ...
        public bool broadcastPacket(Packets.Packet packet, Channel channelNo, PacketFlags flag = PacketFlags.Reliable)
        {
        ...
        public bool broadcastPacketTeam(Team team, Packets.Packet packet, Channel channelNo, PacketFlags flag = PacketFlags.Reliable)
        {
            return broadcastPacketTeam(team, packet.GetBytes(), channelNo, flag);
        }

        public bool broadcastPacketVision(GameObject o, Packets.Packet packet, Channel channelNo, PacketFlags flag = PacketFlags.Reliable)
        {
