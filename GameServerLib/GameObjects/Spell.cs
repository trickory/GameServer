...
namespace LeagueSandbox.GameServer.GameObjects
{
    ...
    {
        public Obj_AI_Base Caster { get; private set; }
        public Obj_AI_Base Target { get; private set; }
        public Vector3 Position { get; private set; }
        public Vector3 Direction { get; private set; }

        public CastInfo(Obj_AI_Base caster, Obj_AI_Base target, Vector3 position, Vector3 direction)
        {
            this.Caster = caster;
            this.Target = target;
    ...
    public class Spell
    {
        public Obj_AI_Hero Owner { get; private set; }
        ...
        public Spell(Obj_AI_Hero owner, string spellName, byte slot)
        {
            Owner = owner;
        ...
        /*
        public void LoadExtraSpells(Obj_AI_Hero champ)
        {
            JObject data;
        ...
        /// </summary>
        public virtual bool cast(float x, float y, Obj_AI_Base u = null, uint futureProjNetId = 0, uint spellNetId = 0)
        {
            X = x;
            Y = y;
            Target = u;
        ...
        public void spellAnimation(string animName, Obj_AI_Base target)
        {
            _game.PacketNotifier.NotifySpellAnimation(target, animName);
        }

        public void setAnimation(string animation, string animation2, Obj_AI_Base target)
        {
            List<string> animList = new List<string> { animation, animation2 };
            _game.PacketNotifier.NotifySetAnimation(target, animList);
        }

        public void resetAnimations(Obj_AI_Base target)
        {
        ...
        public void LoadLua(IScriptEngine scriptEngine)
        {
            ...
            scriptEngine.RegisterFunction("spellAnimation", this, typeof(Spell).GetMethod("spellAnimation", new[] { typeof(string), typeof(Obj_AI_Base) }));
            scriptEngine.RegisterFunction("setAnimation", this, typeof(Spell).GetMethod("setAnimation", new[] { typeof(string), typeof(string), typeof(Obj_AI_Base) }));
            scriptEngine.RegisterFunction("resetAnimations", this, typeof(Spell).GetMethod("resetAnimations", new[] { typeof(Obj_AI_Base) }));
            ...
            scriptEngine.RegisterFunction("teleport", this, typeof(Spell).GetMethod("Teleport", new[] { typeof(Obj_AI_Base), typeof(float), typeof(float) }));
        ...
        public void Teleport(Obj_AI_Base target, float x, float y)
        {
        ...
        public virtual void levelUp()
        {
            ...
            if (Slot < 4)
            {
                Owner.Stats.ManaCost[Slot] = cost[Level - 1];
            }
        }
