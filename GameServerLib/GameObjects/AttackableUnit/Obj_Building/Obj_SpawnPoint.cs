...
namespace LeagueSandbox.GameServer.GameObjects
{
    public class Obj_SpawnPoint : Obj_Building
    {
        ...
        private Game _game = GameServer.ResolveDependency<Game>(); 
        */
        ...
        public Obj_SpawnPoint(short index, uint networkId) : base(index, networkId)
        {
            /*
            _x = x;
            _y = y;
        ...
        public Obj_SpawnPoint(Team team, float x, float y)
        {
            this.Team = team;
            this.Position = new System.Numerics.Vector3(x, y, 0);
        }
