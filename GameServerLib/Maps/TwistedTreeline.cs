...
namespace LeagueSandbox.GameServer.Maps
{
    class TwistedTreeline : Map
    {
        ...
        private Dictionary<Team, float[]> _endGameCameraPosition = new Dictionary<Team, float[]>
        {
            { Team.Order, new[] { 2981.0388f, 7283.0103f, 188 } },
            { Team.Chaos, new[] { 12379.5439f, 7289.9409f, 110 } }
        };
        ...
        public TwistedTreeline(Game game) : base(game, 90 * 1000, 30 * 1000, 90 * 1000, true, 1)
        {
            ...
            AddObject(new LaneTurret("Turret_OrderTurretShrine_A", 295.03690f, 7271.2344f, Team.Order, TurretType.FountainTurret));
            AddObject(new LaneTurret("Turret_T1_C_01_A", 2407.5815f, 7288.8584f, Team.Order, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T1_C_06_A", 2135.5176f, 9264.0117f, Team.Order, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T1_C_07_A", 2130.2964f, 5241.2646f, Team.Order, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T1_L_02_A", 4426.5811f, 9726.0859f, Team.Order, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T1_R_02_A", 4645.6836f, 4718.1982f, Team.Order, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));

            AddObject(new LaneTurret("Turret_ChaosTurretShrine_A", 15020.6406f, 7301.6836f, Team.Chaos, TurretType.FountainTurret));
            AddObject(new LaneTurret("Turret_T2_C_01_A", 13015.4688f, 7289.8652f, Team.Chaos, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T2_L_01_A", 13291.2676f, 9260.7080f, Team.Chaos, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_R_01_A", 13297.6621f, 5259.0078f, Team.Chaos, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_R_02_A", 10775.8760f, 4715.4580f, Team.Chaos, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T2_L_02_A", 10994.5430f, 9727.7715f, Team.Chaos, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            ...
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 2155.8677f, 8411.2500f, SIGHT_RANGE, 0xffd23c3e)); //top
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 2147.5042f, 6117.3418f, SIGHT_RANGE, 0xff9303e1)); //bot
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 13284.7002f, 8408.0605f, SIGHT_RANGE, 0xff6793d0)); //top
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 13295.3809f, 6124.8110f, SIGHT_RANGE, 0xff26ac0f)); //bot

            AddObject(new Nexus("OrderNexus", Team.Order, COLLISION_RADIUS, 2981.0388f, 7283.0103f, SIGHT_RANGE, 0xfff97db5));
            AddObject(new Nexus("ChaosNexus", Team.Chaos, COLLISION_RADIUS, 12379.5439f, 7289.9409f, SIGHT_RANGE, 0xfff02c0f));
        ...
        {
            var dic = new Dictionary<Team, Target>
            {
                { Team.Order, new Target(1051.19f, 7283.599f) },
                { Team.Chaos, new Target(14364, 7277) }
            };
        ...
        public override Tuple<Team, Vector2> GetMinionSpawnPosition(MinionSpawnPosition spawnPosition)
        {
            switch (spawnPosition)
            {
                case MinionSpawnPosition.SPAWN_BLUE_TOP:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(2604, 7930));
                case MinionSpawnPosition.SPAWN_BLUE_BOT:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(2600, 6633));
                case MinionSpawnPosition.SPAWN_RED_TOP:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(12712, 7900));
                case MinionSpawnPosition.SPAWN_RED_BOT:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(12721, 6602));
            }
