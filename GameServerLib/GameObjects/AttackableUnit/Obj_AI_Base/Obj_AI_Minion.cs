...
namespace LeagueSandbox.GameServer.GameObjects
{
    ...
    public class Obj_AI_Minion : Obj_AI_Base
    {
        ...
        public Vector3 LeashedPosition { get; set; }
        public MinionSpawnPosition SpawnPosition { get; private set; }
        public MinionSpawnType MinionType { get; set; }
        ...
        public Obj_AI_Minion(short index, uint netId) : base(index, netId)
        {
        }
        ...
        ) : base("", new MinionStats(), 40, 0, 0, 1100, netId)
        {
            ...
            var minionModel = "";
            if (spawnSpecifics.Item1 == Enet.Team.Order) // If we're the blue side
            {
