...
namespace LeagueSandbox.GameServer.Maps
{
    public class Map
    {
        ...
        private Dictionary<Team, Dictionary<uint, Unit>> _visionUnits;
        ...
        public AIMesh AIMesh { get; protected set; }
        public int Id { get; private set; }

        protected CollisionHandler _collisionHandler;
        protected Dictionary<Team, Fountain> _fountains;
        private readonly List<Team> _teamsIterator;
        ...
        public Map(Game game, long firstSpawnTime, long spawnInterval, long firstGoldTime, bool hasFountainHeal, int id)
        {
            ...
            _visionUnits = new Dictionary<Team, Dictionary<uint, Unit>>();
            ...
            _fountains = new Dictionary<Team, Fountain>
            {
                { Team.Order, new Fountain(Team.Order, 11, 250, 1000) },
                { Team.Chaos, new Fountain(Team.Chaos, 13950, 14200, 1000) }
            };
            Id = id;

            _teamsIterator = Enum.GetValues(typeof(Team)).Cast<Team>().ToList();
        ...
        public virtual void Update(float diff)
        {
            ...
            foreach (var obj in temp.Values)
            {
                ...
                foreach (var team in _teamsIterator)
                {
                    if (u.Team == team || team == Team.Neutral)
                        continue;
        ...
        public virtual Tuple<Team, Vector2> GetMinionSpawnPosition(MinionSpawnPosition spawnPosition)
        {
            return null;
        }
        ...
        public bool AllInhibitorsDestroyedFromTeam(Team team)
        {
        ...
        public Dictionary<uint, Unit> GetVisionUnits(Team team)
        {
        ...
        public void RemoveVisionUnit(Team team, uint netId)
        {
            lock (_visionLock)
                _visionUnits[team].Remove(netId);
        }

        public virtual Target GetRespawnLocation(Team team)
        {
            return null;
        }
        ...
        public List<Champion> GetAllChampionsFromTeam(Team team)
        {
        ...
        public bool TeamHasVisionOn(Team team, GameObject o)
        {
            if (o == null)
                return false;
        ...
        public virtual float[] GetEndGameCameraPosition(Team team)
        {
