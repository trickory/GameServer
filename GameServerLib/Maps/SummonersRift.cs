...
using LeagueSandbox.GameServer.RAF;
...
namespace LeagueSandbox.GameServer.Maps
{
    class SummonersRift : Map
    {
        ...
        private static readonly Dictionary<Team, float[]> _endGameCameraPosition = new Dictionary<Team, float[]>
        {
            { Team.Order, new float[] { 1170, 1470, 188 } },
            { Team.Chaos, new float[] { 12800, 13100, 110 } }
        };

        private static readonly Dictionary<Team, Target> _spawnsByTeam = new Dictionary<Team, Target>
        {
            {Team.Order, new Target(25.90f, 280)},
            {Team.Chaos, new Target(13948, 14202)}
        };
        ...
        public SummonersRift(Game game) : base(game, 90 * 1000, 30 * 1000, 90 * 1000, true, 1)
        {
            ...
            AddObject(new LaneTurret("Turret_T1_R_03_A", 10097.62f, 808.73f, Team.Order,
                TurretType.OuterTurret, GetTurretItems(TurretType.OuterTurret)));
            AddObject(new LaneTurret("Turret_T1_R_02_A", 6512.53f, 1262.62f, Team.Order,
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T1_C_07_A", 3747.26f, 1041.04f, Team.Order,
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_R_03_A", 13459.0f, 4284.0f, Team.Chaos,
                TurretType.OuterTurret, GetTurretItems(TurretType.OuterTurret)));
            AddObject(new LaneTurret("Turret_T2_R_02_A", 12920.0f, 8005.0f, Team.Chaos,
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T2_R_01_A", 13205.0f, 10474.0f, Team.Chaos,
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T1_C_05_A", 5448.02f, 6169.10f, Team.Order,
                TurretType.OuterTurret, GetTurretItems(TurretType.OuterTurret)));
            AddObject(new LaneTurret("Turret_T1_C_04_A", 4657.66f, 4591.91f, Team.Order,
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T1_C_03_A", 3233.99f, 3447.24f, Team.Order,
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T1_C_01_A", 1341.63f, 2029.98f, Team.Order,
                TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T1_C_02_A", 1768.19f, 1589.47f, Team.Order,
                TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T2_C_05_A", 8548.0f, 8289.0f, Team.Chaos,
                TurretType.OuterTurret, GetTurretItems(TurretType.OuterTurret)));
            AddObject(new LaneTurret("Turret_T2_C_04_A", 9361.0f, 9892.0f, Team.Chaos,
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T2_C_03_A", 10743.0f, 11010.0f, Team.Chaos,
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_C_01_A", 12662.0f, 12442.0f, Team.Chaos,
                TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T2_C_02_A", 12118.0f, 12876.0f, Team.Chaos,
                TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_OrderTurretShrine_A", -236.05f, -53.32f,Team.Order,
                TurretType.FountainTurret, GetTurretItems(TurretType.FountainTurret)));
            AddObject(new LaneTurret("Turret_ChaosTurretShrine_A", 14157.0f, 14456.0f, Team.Chaos,
                TurretType.FountainTurret, GetTurretItems(TurretType.FountainTurret)));
            AddObject(new LaneTurret("Turret_T1_L_03_A", 574.66f, 10220.47f, Team.Order, 
                TurretType.OuterTurret, _turretItems[TurretType.OuterTurret]));
            AddObject(new LaneTurret("Turret_T1_L_02_A", 1106.26f, 6485.25f, Team.Order,
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T1_C_06_A", 802.81f, 4052.36f, Team.Order,
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_L_03_A", 3911.0f, 13654.0f, Team.Chaos,
                TurretType.OuterTurret, _turretItems[TurretType.OuterTurret]));
            AddObject(new LaneTurret("Turret_T2_L_02_A", 7536.0f, 13190.0f, Team.Chaos, 
                TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            AddObject(new LaneTurret("Turret_T2_L_01_A", 10261.0f, 13465.0f, Team.Chaos, 
                TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            ...
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 835, 3400, SIGHT_RANGE, 0xffd23c3e)); //top
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 2785, 3000, SIGHT_RANGE, 0xff4a20f1)); //mid
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 3044, 1070, SIGHT_RANGE, 0xff9303e1)); //bot
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 10960, 13450, SIGHT_RANGE, 0xff6793d0)); //top
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 11240, 11490, SIGHT_RANGE, 0xffff8f1f)); //mid
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 13200, 11200, SIGHT_RANGE, 0xff26ac0f)); //bot

            AddObject(new Nexus("OrderNexus", Team.Order, COLLISION_RADIUS, 1170, 1470, SIGHT_RANGE, 0xfff97db5));
            AddObject(new Nexus("ChaosNexus", Team.Chaos, COLLISION_RADIUS, 12800, 13100, SIGHT_RANGE, 0xfff02c0f));
        ...
        public override Target GetRespawnLocation(Team team)
        {
        ...
        public override Tuple<Team, Vector2> GetMinionSpawnPosition(MinionSpawnPosition spawnPosition)
        {
            switch (spawnPosition)
            {
                case MinionSpawnPosition.SPAWN_BLUE_TOP:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(907, 1715));
                case MinionSpawnPosition.SPAWN_BLUE_BOT:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(1533, 1321));
                case MinionSpawnPosition.SPAWN_BLUE_MID:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(1443, 1663));
                case MinionSpawnPosition.SPAWN_RED_TOP:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(14455, 13159));
                case MinionSpawnPosition.SPAWN_RED_BOT:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(12967, 12695));
                case MinionSpawnPosition.SPAWN_RED_MID:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(12433, 12623));
            }
            return new Tuple<Team, Vector2>(0, new Vector2());
        }
        ...
        public override bool Spawn()
        {
            ...
            foreach (var pos in positions)
            {
                ...
                var oppositeTeam = Team.Order;
                if (inhibitor.Team == Team.Chaos)
                {
                    oppositeTeam = Team.Chaos;
                }
        ...
        public override float[] GetEndGameCameraPosition(Team team)
        {
