...
namespace LeagueSandbox.GameServer.GameObjects
{
    ...
    public class LaneTurret : BaseTurret
    {
        ...
        public int GetEnemyChampionsCount()
        {
            ...
            foreach (var player in _game.Map.GetAllChampionsFromTeam(Enet.Team.Order))
            {
                blueTeam.Add(player);
            }

            foreach (var player in _game.Map.GetAllChampionsFromTeam(Enet.Team.Chaos))
            {
                purpTeam.Add(player);
            }
            if (Team == Enet.Team.Order)
