...
namespace LeagueSandbox.GameServer.Content
{
    public class ContentManager
    {
        ...
        private static readonly string[] CONTENT_TYPES =
        {
            "Champions",
            "Items",
            "Buffs",
        ...
        {
            const string contentType = "Champions";
        ...
        {
            const string contentType = "Buffs";
        ...
        {
            const string contentType = "Stats";
        ...
        {
            const string contentType = "Spells";
