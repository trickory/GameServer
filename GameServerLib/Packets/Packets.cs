...
namespace LeagueSandbox.GameServer.Packets
{
    ...
    {
        public SetTeam(Unit unit, Team team) : base(PacketCmd.PKT_S2C_SetTeam)
        {
            buffer.Write(unit.NetId);
    ...
    {
        public ExplodeNexus(Nexus nexus) : base(PacketCmd.PKT_S2C_BuildingDie, nexus.NetId)
        {
            // animation ID?
    ...
    {
        public Surrender(Unit starter, byte flag, byte yesVotes, byte noVotes, byte maxVotes, Team team, float timeOut)
