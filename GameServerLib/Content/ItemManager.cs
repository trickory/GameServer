    ...
    public class ItemType : IBuff
    {
        ...
        public static ItemType Load(ItemManager owner, ItemContentCollectionEntry itemInfo)
        {
            ...
            var result = new ItemType(owner, itemInfo)
            {
                ...
                AttackSpeed =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "PercentAttackSpeedMod")
                },
                Armor =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatArmorMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentArmorMod")
                },
                CriticalChance =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatCritChanceMod")
                },
                HealthPoints =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatHPPoolMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentHPPoolMod")
                },
                ManaPoints =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatMPPoolMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentMPPoolMod")
                },
                AbilityPower =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatMagicDamageMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentMagicDamageMod")
                },
                MagicPenetration =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatMagicPenetrationMod")
                },
                MoveSpeed =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatMovementSpeedMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentMovementSpeedMod")
                },
                AttackDamage =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatPhysicalDamageMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentPhysicalDamageMod")
                },
                MagicResist =
                {
                    FlatBonus = itemInfo.SafeGetFloat("Data", "FlatSpellBlockMod"),
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentSpellBlockMod")
                },
                HealthRegeneration =
                {
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentBaseHPRegenMod")
                },
                ManaRegeneration =
                {
                    PercentBonus = itemInfo.SafeGetFloat("Data", "PercentBaseMPRegenMod")
                }
            };
