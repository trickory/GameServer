...
namespace LeagueSandbox.GameServer.GameObjects
{
    public class Obj_AI_Hero : Obj_AI_Base
    {
        ...
        public RuneCollection Runes { get; set; }
        public int SpellTrainingPoints { get; set; }
        ...
        //TODO: Event Args!
        public delegate void Spawn(Obj_AI_Base sender, EventArgs args);
        public delegate void Death(Obj_AI_Base sender, EventArgs args);
        ...
        public Obj_AI_Hero(short index, uint networkId) : base(index, networkId)
        {
        }

        public Obj_AI_Hero(string championName, uint userId, uint playerId, RuneCollection runes, ClientInfo cInfo)
        {
        ...
        public Obj_AI_Hero(string model,
                        uint playerId,
        ...
        public Spell castSpell(byte slot, float x, float y, Obj_AI_Base target, uint futureProjNetId, uint spellNetId)
        {
            Spell s = null;
        ...
        public override void die(Obj_AI_Base killer)
        {
            ...
            {
                cKiller = _game.Map.GetObjectById(_playerHitId) as Obj_AI_Hero;
        ...
        public override void dealDamageTo(Obj_AI_Base target, float damage, DamageType type, DamageSource source, bool isCrit)
        {
            base.dealDamageTo(target, damage, type, source, isCrit);

            var cTarget = target as Obj_AI_Hero;
            if (cTarget == null)
                return;
