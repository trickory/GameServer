...
namespace LeagueSandbox.GameServer.Maps
{
    class HowlingAbyss : Map
    {
        ...
        {
            { Team.Order, new[] { 1849.2987f, 1962.8167f, -192.4576f } },
            { Team.Chaos, new[] { 10916.8809f, 10708.5723f, -198.1245f } }
        };
        ...
        public HowlingAbyss(Game game) : base(game, 90 * 1000, 30 * 1000, 90 * 1000, false, 12)
        {
            ...
            AddObject(new LaneTurret("Turret_OrderTurretShrine_A", 648.0914f, 764.2271f, Team.Order, TurretType.FountainTurret));
            AddObject(new LaneTurret("Turret_T1_C_09_A", 2493.2317f, 2101.1807f, Team.Order, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T1_C_010_A", 2036.6566f, 2552.6812f, Team.Order, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T1_C_07_A", 3809.0610f, 3829.0515f, Team.Order, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T1_C_08_A", 4943.4775f, 4929.8193f, Team.Order, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));

            AddObject(new LaneTurret("Turret_ChaosTurretShrine_A", 12168.7266f, 11913.2891f, Team.Chaos, TurretType.FountainTurret));
            AddObject(new LaneTurret("Turret_T2_L_04_A", 10325.2227f, 10608.1982f, Team.Chaos, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T2_L_03_A", 10785.1777f, 10117.5869f, Team.Chaos, TurretType.NexusTurret, GetTurretItems(TurretType.NexusTurret)));
            AddObject(new LaneTurret("Turret_T2_L_02_A", 9017.6309f, 8871.3613f, Team.Chaos, TurretType.InhibitorTurret, GetTurretItems(TurretType.InhibitorTurret)));
            AddObject(new LaneTurret("Turret_T2_L_01_A", 7879.1025f, 7774.8018f, Team.Chaos, TurretType.InnerTurret, GetTurretItems(TurretType.InnerTurret)));
            ...
            AddObject(new Inhibitor("OrderInhibitor", Team.Order, COLLISION_RADIUS, 3128.5122f, 3171.5120f, SIGHT_RANGE, 0xff4a20f1));
            AddObject(new Inhibitor("ChaosInhibitor", Team.Chaos, COLLISION_RADIUS, 9699.4023f, 9515.8262f, SIGHT_RANGE, 0xffff8f1f));


            AddObject(new Nexus("OrderNexus", Team.Order, COLLISION_RADIUS, 1849.2987f, 1962.8167f, SIGHT_RANGE, 0xfff97db5));
            AddObject(new Nexus("ChaosNexus", Team.Chaos, COLLISION_RADIUS, 10916.8809f, 10708.5723f, SIGHT_RANGE, 0xfff02c0f));
        ...
        public override Target GetRespawnLocation(Team team)
        {
            var dic = new Dictionary<Team, Target>
            {
                ...
                { Team.Chaos, new Target(11716, 11502) }
            };
        ...
        public override Tuple<Team, Vector2> GetMinionSpawnPosition(MinionSpawnPosition spawnPosition)
        {
            switch (spawnPosition)
            {
                case MinionSpawnPosition.SPAWN_BLUE_MID:
                    return new Tuple<Team, Vector2>(Team.Order, new Vector2(1996, 2324));
                case MinionSpawnPosition.SPAWN_RED_MID:
                    return new Tuple<Team, Vector2>(Team.Chaos, new Vector2(10835, 10376));
            }
